<script lang="ts">
  ...
  let x = 812,
    ...
    w = 127,
    h = 165,
    id = "main_office"; // h is the offset for the tooltip now
...
transform: translate({translateValue}px, {translateValue}px) scale({scaleValue}%, {scaleValue}%);{ $glow.includes(id) ? " box-shadow: 8px 8px 20px yellow, -8px 8px 20px yellow, 8px -8px 20px yellow, -8px -8px 20px yellow; z-index: 1;" : "" }">
  <div>
              ...
              <g id="Admin" transform="matrix(1.06048,0,0,1.46799,2468.98,-1469.03)">
                ...
                <g clip-path="url(#_clip2)">
                  <g transform="matrix(1.39099,0,0,1,-1997.79,359.033)">
                    <path
                      d="M2266.64,1194.82L2043.66,1194.82C2036.63,1194.82 2030.92,1202.76 2030.92,1212.54C2030.92,1271.92 2030.92,1463.49 2030.92,1522.87C2030.92,1532.65 2036.63,1540.58 2043.66,1540.58C2084.66,1540.58 2212.9,1540.58 2253.9,1540.58C2260.93,1540.58 2266.64,1532.65 2266.64,1522.87L2266.64,1194.82Z" />
                  </g>
                  <g transform="matrix(0.843371,0,0,1.01522,-842.443,152.589)">
                    <path
                      d="M2483.66,1310.28L2083.78,1310.28L2083.78,1486.5L2462.7,1486.5C2474.27,1486.5 2483.66,1478.71 2483.66,1469.09C2483.66,1424.61 2483.66,1310.28 2483.66,1310.28Z" />
                  </g>
                  <g transform="matrix(1.2027,0,0,1.33112,-1570.88,-235.559)">
                    <path
                      d="M2266.64,1194.82L2045.65,1194.82C2037.52,1194.82 2030.92,1200.78 2030.92,1208.13C2030.92,1271.62 2030.92,1540.58 2030.92,1540.58L2266.64,1540.58L2266.64,1194.82Z" />
                  </g>
                  <g transform="matrix(1,0,0,1,-1244.15,171.608)">
                    <path
                      d="M2496.5,1200.88C2496.5,1191.1 2488.57,1183.17 2478.79,1183.17L2266.93,1183.17L2266.93,1391.46L2496.5,1391.46L2496.5,1200.88Z" />
                  </g>
                </g>
              </g>
            </g>
    ...
    <h2
      ...
      style="transform: translate(25px, -{h / 2 + 20}px);">
      {displayName}
    </h2>
  </div>
