<script lang="ts">
  ...
  import data from "$lib/data";
    import MusicButton from "$lib/components/MusicButton.svelte";
...
<div class="w-full h-full">
  ...
  <div class="absolute right-6 top-4">
    ...
    <svg viewBox="0 0 98 96" class="w-10 h-auto fill-rose-800 hover:fill-amber-400 hover:scale-105" xmlns="http://www.w3.org/2000/svg">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          ...
          class="fill-inherit transition ease-in"
        />
      </svg>
    </a>
  </div>
